...
const Image = props => {
    ...
    const placeholderHeight = shimmerHeight && isMobile ? shimmerHeightMobile : shimmerHeight;

    const imageShimmer = !handleLoad && placeholderHeight && (
        <Shimmer width={!shimmerWidth && '100%'} height={placeholderHeight} />
    );
