...
const GalleryItem = ({ product: item, onItemClick, classes: propClasses, storeConfig }) => {
    ...
    const mediaLabel = media_gallery_entries ? media_gallery_entries[0].label : 'small Image';
    ...
    const priceCurrency = price_range.maximum_price.final_price.currency;
