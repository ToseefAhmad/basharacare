...
import DEFAULT_OPERATIONS from '@magento/peregrine/lib/talons/CartPage/PriceAdjustments/ShippingMethods/shippingMethods.gql';
...
export const useShippingMethods = (props = {}) => {
    ...
    useEffect(() => {
        if (data?.cart?.shipping_addresses?.length) {
