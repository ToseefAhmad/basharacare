...
import SignIn from '@app/components/overrides/SignIn/signIn';
...
const AccountMenu = React.forwardRef(({ accountMenuIsOpen, setAccountMenuIsOpen, classes: propClasses }, ref) => {
